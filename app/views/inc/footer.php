        ...
        <section class="">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <p>
                        <a  class="text-white" href="<?php echo URLROOT; ?>/pages/shop">Home</a>
                    </p>
                    <p>
                        <a class="text-white" href="<?php echo URLROOT; ?>/pages/shop">Shop</a>
                    </p>
                    <p>
                        <a   class="text-white" href="<?php echo URLROOT; ?>/pages/about">About</a>
                    </p>
                    <p>
                        <a  class="text-white" href="<?php echo URLROOT; ?>/pages/contact">Contact Us</a>
                    </p>
                </div>
                <hr class="w-100 clearfix d-md-none" />
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p><i class="fas fa-envelope mr-3"></i> SmartShop@gmail.com</p>
